...
const AREA_RULES: AreaRule[] = [
  {
    area: "Tests",
    patterns: ["/test/", "/tests/", "/spec/", "/__tests__/", ".test.", ".spec."],
  },
  {
    area: "Build/Config",
    patterns: [
      "tsconfig", "vite.config", "webpack.config", ".eslintrc", "eslint.config",
      ".prettierrc", "prettier.config", "babel.config", "jest.config",
      "rollup.config", ".env", "dockerfile", "docker-compose", ".github/", "ci/",
    ],
  },
  {
    area: "Auth",
    patterns: ["/auth/", "/login/", "/logout/", "/session/", "/token/", "auth.", "login.", "session.", "token."],
  },
  {
    area: "Routing",
    patterns: ["/routes/", "/router/", "/navigation/", "routes.", "router.", "navigation.", "routing."],
  },
  {
    area: "State",
    patterns: ["/redux/", "/store/", "/slice/", "/slices/", "store.", "slice.", "reducer.", ".store.", ".slice."],
  },
  {
    area: "Hooks",
  ...
  {
    area: "API/Service",
    patterns: ["/services/", "/service/", "/api/", "/client/", "/clients/", "service.", "api.", "client."],
  },
  {
    area: "Styling",
    patterns: [
      "/styles/", "/style/", "/tailwind/", "/tokens/", "/theme/",
      ".css", ".scss", ".less", "tailwind.config", "theme.", "tokens.",
    ],
  },
  {
    area: "Types",
    patterns: ["/types/", "/interfaces/", "/schema/", "/schemas/", "types.", "interface.", ".d.ts"],
  },
  {
    area: "UI",
    patterns: ["/components/", "/component/", "/pages/", "/page/", "/screens/", "/screen/", "/ui/", "/views/", "/view/"],
  },
];
